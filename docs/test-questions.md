...
- `backend/data/eval-reports/20260910T143451144832Z-baseline.json`
- `backend/data/eval-reports/20260910T143504806177Z-hybrid.json`
...
| hybrid | 14 | 10 | 0.700 | 0.800 | 0.750 | 0.275 | 1.000 |

本轮对混合检索进行了两项改动：当所有 BM25 分数为 0 时回退到向量结果，避免无意义的词法排序；为常见中文汽车术语补充有限英文别名。结果是 Recall@1 从 0.400 提升到 0.700，MRR 从 0.600 提升到 0.750，候选引用精度维持 0.275；但 Recall@3 从 0.900 降为 0.800。因此该策略改善了首条证据质量，但尚不能声称在全部指标上优于基线。拒答准确率保持 1.000，只说明未导入 BYD 手册时没有跨车型返回证据，不代表回答质量达标。
...
| hybrid | `civic-trunk-opener` | 189 | 23, 178, 191, 190 | 未检出期望页 |
| hybrid | `toyota-emergency-stop-cancel` | 17 | 16, 18, 16, 16 | 未检出期望页 |
